...
#define W25Qxx_FlashSize       				0x800000		// W25Q256��С��32M�ֽ�
#define W25Qxx_FLASH_ID           			0xEF4019    // W25Q256 JEDEC ID
#define W25Qxx_ChipErase_TIMEOUT_MAX		120000U		// ��ʱ�ȴ�ʱ�䣬W25Q256��Ƭ�����������ʱ����120S
...
#define  QUADSPI_BK1_IO1_PIN						GPIO_PIN_10								// QUADSPI_BK1_IO1 ����
#define	QUADSPI_BK1_IO1_PORT						GPIOC										// QUADSPI_BK1_IO1 ���Ŷ˿�
