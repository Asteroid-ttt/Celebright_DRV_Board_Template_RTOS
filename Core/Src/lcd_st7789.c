...
void SPI_LCD_Init(void)
{
   ...
   HAL_Delay(10);               	// ��Ļ����ɸ�λʱ�������ϵ縴λ������Ҫ�ȴ�����?ms���ܷ���ָ��

 	LCD_WriteCommand(0x36);       // �Դ���ʿ���?ָ��������÷����Դ�ķ��?
...
// ���½���һЩ������Ĭ������
   ...
   LCD_ShowNumMode(Fill_Zero);	      	// ���ñ�����ʾģʽ������λ���ո������?
...
*					2. ʹ��ʾ�� LCD_ShowNumMode(Fill_Zero) ���ö���λ���?������ 123 ������ʾΪ 000123
*
*****************************************************************************************************************************************/
...
*							ʾ��2��С�� -123.123 ��ָ�� len =10 �Ļ�����ʵ�����?  -123.123(����ǰ����������ո��? 
*							ʾ��3��С�� -123.123 ��ָ�� len =10 �Ļ��������ú��� LCD_ShowNumMode() ����Ϊ���?ģʽʱ��ʵ�����?-00123.123 
*
...
{  
	...
	if( LCD.ShowNum_Mode == Fill_Zero)	// ����λ���?ģʽ
	{
...
// ��Ϊ��������С���ޣ���Ҫ�ֶ��д��?
   Buff_Height = (sizeof(LCD_Buff)/2) / height;    // ���㻺�����ܹ�д��ͼƬ�Ķ�����
	...
	for(i = 0; i <height; i++)             // ѭ������д��
	{
      ...
      if( BuffCount == Buff_Height*width  )  // �ﵽ�������������ɵ���������?
      {
         BuffCount = 0; // ������������0
...
*           int y0 - Բ��������
*           unsigned char r - Բ�뾶
*           unsigned char cornername - Բ���ĸ��ǵ�����?
* �� �� ֵ: ��
* ��������: ��LCD�ϻ���Բ��һ���֣���ѡ����Ƶ�Բ��?
