...
|--------|--------|--------|------|--------|------|
| `_9axisService` | Normal3(27) | 128 | 5ms | Sensor | 读取 IMU 姿态 + 陀螺仪数据 |
| `CarAttitude` | Normal5(29) | 128 | 10ms | Control | 编码器更新 → 电机 PID → 控制 PID → 姿态输出 |
| `Key` | Normal6(30) | 128 | idle | Device | 矩阵键盘扫描 |
| `LEDBlink` | AboveNormal(32) | 128 | 1s | — | LED0 闪烁 |
| `Uart3Handle` | Normal7(31) | 256 | block | Device | UART3 帧解析 |
| `Uart4Handle` | Normal7(31) | 256 | block | Device | UART4 帧解析 |
| `Broadcast` | Normal1(25) | 256 | 50ms | Device | 蓝牙广播 |
| `Screen_LCD` | Normal1(25) | 128 | 100ms | Device | OLED 显示 |
| `Buzzer` | Normal1(25) | 128 | idle | Device | 蜂鸣器（暂未启用） |
| `todo` | Normal1(25) | 1024 | 50ms | — | 待开发占位 |
| `Task_APP (Test)` | Normal5(29) | 512 | once | — | 直行 1000mm → 自删除 |
